...
const API_URL = import.meta.env.VITE_API_URL + "/aseguradoras";
...
export const crearAseguradora = async (data) => {
  try {
...
export const actualizarAseguradora = async (id, data) => {
  try {
...
export const cambiarEstadoAseguradora = async (id, data) => {
  try {
